...
namespace cAlgo
{
    ...
    public class CopexClient : Robot
    {
        ...
        [Parameter("Multiply Volume", DefaultValue = 0.1, MinValue = 0.1, MaxValue = 100)]
        ...
        [Parameter("Max Positions", DefaultValue = 100, MinValue = 100)]
        ...
        protected override void OnStart()
        {
            ...
            path = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\cAlgo\\cBotID" + Account.Number;
